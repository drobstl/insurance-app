...
export default function BookHealthPopover({ breakdown, open, onClose }: Props) {
  ...
  return (
    <div
      ref={ref}
      className="absolute top-full right-0 mt-2 bg-white rounded-[8px] shadow-xl border border-[#d0d0d0] p-5 z-50 w-[320px] animate-in fade-in slide-in-from-top-2 duration-200"
    >
