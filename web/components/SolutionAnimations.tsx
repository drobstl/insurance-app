...
export function AppToDashboardBridge() {
  ...
  const pathFade = useTransform(scrollYProgress, [0, 0.1], [0, 1]);
  ...
  return (
    ...
    >
        ...
        >
          <defs>
            <linearGradient id="bridgeGradient" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="100%" stopColor="#3DD6C3" stopOpacity="0.4" />
            </linearGradient>
          ...
          <motion.path
            d="M 400 10 C 400 60, 280 100, 280 150 C 280 200, 400 240, 400 290"
            stroke="#3DD6C3"
            strokeOpacity="0.08"
            strokeWidth="3"
            fill="none"
            style={{ opacity: pathFade }}
          />
          <motion.path
            d="M 400 10 C 400 60, 280 100, 280 150 C 280 200, 400 240, 400 290"
            ...
            style={{ pathLength: pathLen, opacity: pathFade }}
            strokeLinecap="round"
          />
        </svg>
      </div>
      ...
      <motion.div
        ...
        transition={{ type: 'spring', stiffness: 300, damping: 20 }}
      >
        <div className="w-3.5 h-3.5 rounded-full bg-[#3DD6C3] shadow-[0_0_10px_rgba(61,214,195,0.5)]" />
      ...
      <motion.div
        className="absolute left-6 -translate-x-1/2 bottom-[15%] z-10 md:hidden"
        initial={{ scale: 0, opacity: 0 }}
        whileInView={{ scale: 1, opacity: 1 }}
        viewport={{ once: true }}
        transition={{ type: 'spring', stiffness: 300, damping: 20 }}
