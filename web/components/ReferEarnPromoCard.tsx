 ...
 * earns passive income. Numbers mirror the refer-and-earn page (20% of year-1
...
export default function ReferEarnPromoCard() {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#0D4D4D] to-[#1a6868] ring-1 ring-[#f5c542]/50 animate-[goldGlow_3s_ease-in-out_infinite] p-4 w-full md:w-[300px] shrink-0">
      <div className="flex items-center gap-2 mb-2">
        <div className="w-8 h-8 rounded-full bg-[#f5c542]/20 ring-1 ring-[#f5c542]/40 flex items-center justify-center shrink-0">
        ...
        <p className="text-[10px] font-extrabold uppercase tracking-[0.14em] text-[#f5c542]">
          Refer &amp; Earn
        </p>
      </div>

      <p className="text-white font-extrabold text-base leading-snug">
        Earn <span className="text-[#f5c542]">20%</span> of year-1 for every agent you refer.
      </p>
      <p className="text-white/70 text-xs mt-1">
        Up to $237.60/yr per agent. No cap.
      </p>

      <button
        type="button"
        onClick={() => router.push('/dashboard/refer-and-earn')}
        className="mt-3 w-full bg-[#f5c542] hover:bg-[#ffd860] text-[#0D4D4D] px-4 py-2 rounded-md text-sm font-extrabold transition-colors"
      >
        Start earning →
      </button>
    </div>
