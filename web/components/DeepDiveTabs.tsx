              ...
              <div className="mb-16">
                ...
                <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-start">
                  ...
                  <div className="space-y-4 lg:pt-8">
                    ...
                    <div className="bg-[#F8F9FA] rounded-2xl p-5 border border-gray-100 hover:shadow-lg transition-shadow flex items-start gap-4"><div className="text-2xl flex-shrink-0 mt-0.5">📋</div><div><h3 className="text-base font-bold text-[#0D4D4D] mb-1">Anniversary Alerts</h3><p className="text-[#6B7280] text-sm leading-relaxed">Get alerted as each policy&apos;s one-year anniversary hits — the perfect time to review and offer a rewrite.</p></div></div>
          ...
          {activeTab === 2 && (
            <div>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-[#6B7280] max-w-2xl mx-auto">When a policy hits its one-year mark, your client hears from you — not the carrier. The rewrite comes to you, not the other way around.</p>
              </div>
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-6">
                  <div className="flex gap-4"><div className="flex-shrink-0"><div className="w-12 h-12 bg-[#0D4D4D] rounded-2xl flex items-center justify-center"><svg className="w-6 h-6 text-[#3DD6C3]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg></div></div><div><h3 className="text-lg font-bold text-[#0D4D4D] mb-1">You Get the Heads-Up</h3><p className="text-[#6B7280] leading-relaxed">A few days before each policy&apos;s 1-year anniversary, you get an email digest with every upcoming renewal. No spreadsheets. No manual tracking.</p></div></div>
