  ...
  return (
    <div className="fixed inset-0 z-[60] pointer-events-none">
      {showProfileCelebration && step.id === 'profile' ? (
        <div className="fixed inset-0 z-[75] bg-black/40 pointer-events-auto flex items-center justify-center px-4">
      ...
      {!showProfileCelebration && spotlight && (
        <>
          <div
            className="fixed left-0 right-0 top-0 bg-black/32 pointer-events-auto transition-[height] duration-300 ease-out"
            style={{ height: spotlight.top }}
          />
          <div
            className="fixed left-0 bg-black/32 pointer-events-auto transition-[top,width,height] duration-300 ease-out"
            style={{ top: spotlight.top, width: spotlight.left, height: spotlight.height }}
          />
          <div
            className="fixed right-0 bg-black/32 pointer-events-auto transition-[top,width,height] duration-300 ease-out"
            style={{ top: spotlight.top, width: Math.max(0, spotlight.viewportWidth - spotlight.right), height: spotlight.height }}
          />
          <div
            className="fixed left-0 right-0 bottom-0 bg-black/32 pointer-events-auto transition-[top] duration-300 ease-out"
