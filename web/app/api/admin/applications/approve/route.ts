    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: 'Montserrat', Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #2D3748; line-height: 1.7;">
          ...
          <p style="font-size: 16px;"><strong>You're in.</strong> Welcome to the founding members.</p>
          ...
          <ol style="font-size: 16px; padding-left: 20px;">
            ...
            <li style="margin-bottom: 8px;">Set up your profile with your photo, contact info, and branding</li>
            <li style="margin-bottom: 8px;">Add a few real clients and have them download the app</li>
          </ol>

          <p style="font-size: 16px;">Once you're in the dashboard, you'll see a <strong>Feedback</strong> tab. That's where I'll ask you one quick question a week. Be honest — that's what I need.</p>
