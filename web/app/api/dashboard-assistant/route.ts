...
- **Growth** — $49/mo. 75 conversations/mo, 8/day cap. The post-sale anchor tier — full retention + referral + anniversary engine, bulk import onboarding ceremony, branded mobile app. **No pre-sale tools at this tier.** Most popular.
- **Pro** — $99/mo. 200 conversations/mo, 20/day cap. Everything in Growth **plus the pre-sale unlock**: Lead management, Activity dashboard, the Close-the-sale conveyor (lead → client → policy → activation in one flow), SME/FIF tracking, and the Performance page (paste a call transcript, get AI coaching scores).
