    ...
    <div className="relative max-w-5xl mx-auto">
      ...
      {alertsLoading ? (
        ...
        <div className="bg-white rounded-xl border-2 border-[#1A1A1A] border-r-[4px] border-b-[4px] py-10 px-4 text-center">
          ...
          <p className="text-sm text-[#707070] mb-6">No alerts yet. Flag a policy at risk from the Clients page or forward a carrier email.</p>
          <div className="max-w-md mx-auto">
            <FeatureWalkthrough
              walkthrough="retention"
              label="Watch how Retention works"
