...
const APPLICATION_TYPE_OPTIONS: Array<{ label: string; value: ApplicationFormType }> = [
  ...
  { label: 'United Home Life - Term (ICC22 200-878A)', value: 'uhl_icc22_200_878a' },
  { label: 'Transamerica - Whole Life (ICC22 T-AP-WL11IC-0822)', value: 'transamerica_icc22_t_ap_wl11ic_0822' },
