...
export default function DashboardPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'Active':
        return 'bg-[#D1FAE5] text-[#065F46] border-[#3DD6C3]';
      case 'Pending':
    ...
    return (
      <div className="min-h-screen bg-[#F8F9FA] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <svg className="animate-spin w-10 h-10 text-[#3DD6C3]" fill="none" viewBox="0 0 24 24">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
          </svg>
          <p className="text-[#4A5568] text-lg">Loading...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA]">
      {/* Navigation Bar */}
      <nav className="bg-[#0D4D4D] sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-18">
            {/* Logo */}
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 bg-[#3DD6C3] rounded-xl flex items-center justify-center shadow-lg shadow-[#3DD6C3]/30">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-3 px-4 py-2.5 bg-white/10 hover:bg-white/20 rounded-xl border border-white/20 transition-all duration-200 group"
              >
                {agentProfile.photoBase64 ? (
                  <img
                    src={`data:image/jpeg;base64,${agentProfile.photoBase64}`}
                    alt="Profile"
                    className="w-9 h-9 rounded-full object-cover border-2 border-[#3DD6C3] transition-colors"
                  />
                ) : (
                  <div className="w-9 h-9 rounded-full bg-[#3DD6C3] flex items-center justify-center border-2 border-[#3DD6C3] transition-colors">
              ...
              <button
                ...
                className="px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-xl border border-white/20 transition-all duration-200 flex items-center gap-2 text-sm font-medium"
              >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Welcome Section */}
        <div className="bg-white/50 backdrop-blur-xl rounded-2xl border border-slate-200/50 p-8 shadow-2xl">
          <div className="flex items-start gap-6">
            <div className="w-16 h-16 bg-[#0D4D4D] rounded-2xl flex items-center justify-center shadow-lg shadow-[#3DD6C3]/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white/50 backdrop-blur-xl rounded-2xl border border-slate-200/50 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[#6B7280] text-sm">Total Clients</p>
                <p className="text-2xl font-bold text-[#2D3748]">{clients.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/50 backdrop-blur-xl rounded-2xl border border-slate-200/50 p-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-[#3DD6C3]/20 rounded-xl flex items-center justify-center">
                <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <div>
                <p className="text-[#6B7280] text-sm">Active Policies</p>
                <p className="text-2xl font-bold text-[#2D3748]">{totalActivePolicies}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/50 backdrop-blur-xl rounded-2xl border border-slate-200/50 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[#6B7280] text-sm">Pending Reviews</p>
        ...
        <div className="mt-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-[#3DD6C3] hover:bg-[#0D4D4D] text-white font-semibold rounded-xl shadow-lg shadow-[#3DD6C3]/30 hover:shadow-[#3DD6C3]/40 transition-all duration-200 flex items-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mb-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 bg-white/50 border border-slate-200/50 rounded-xl text-[#2D3748] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all duration-200"
                />
                {searchQuery && (
                  <button
                    onClick={() => setSearchQuery('')}
                    className="absolute right-4 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-slate-100/50 hover:bg-slate-200/50 flex items-center justify-center text-[#6B7280] hover:text-[#2D3748] transition-colors"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {clientsLoading ? (
            <div className="bg-white/50 backdrop-blur-xl rounded-2xl border border-slate-200/50 p-12 flex items-center justify-center">
              <div className="flex flex-col items-center gap-4">
                <svg className="animate-spin w-8 h-8 text-emerald-500" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
                </svg>
                <p className="text-[#6B7280]">Loading clients...</p>
              </div>
            </div>
          ) : clients.length === 0 ? (
            // Empty State
            <div className="bg-white/50 backdrop-blur-xl rounded-2xl border border-slate-200/50 p-12">
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-slate-100/50 rounded-2xl flex items-center justify-center mb-6">
                  <svg className="w-10 h-10 text-[#6B7280]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
                <h3 className="text-xl font-semibold text-[#2D3748] mb-2">No clients yet</h3>
                ...
                <button
                  onClick={handleOpenModal}
                  className="px-6 py-3 bg-[#3DD6C3] hover:bg-[#0D4D4D] text-white font-semibold rounded-xl shadow-lg shadow-[#3DD6C3]/30 hover:shadow-[#3DD6C3]/40 transition-all duration-200 flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
            ...
            <div className="bg-white/50 backdrop-blur-xl rounded-2xl border border-slate-200/50 p-12">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-semibold text-[#2D3748] mb-2">No clients found</h3>
                <p className="text-[#6B7280] mb-4">
                  No clients match &ldquo;{searchQuery}&rdquo;. Try a different search term.
                </p>
                <button
                  onClick={() => setSearchQuery('')}
                  className="px-4 py-2 bg-slate-100/50 hover:bg-slate-200/50 text-[#4A5568] hover:text-[#2D3748] font-medium rounded-xl border border-slate-300/50 transition-all duration-200"
                >
                  Clear Search
                </button>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredClients.map((client) => (
                <div
                  key={client.id}
                  className={`bg-white/50 backdrop-blur-xl rounded-2xl border p-6 transition-all duration-200 group ${
                    selectedClient?.id === client.id
                      ? 'border-emerald-500/50 bg-white/70 ring-1 ring-emerald-500/20'
                      : 'border-slate-200/50 hover:border-slate-300/50 hover:bg-white/70'
                  }`}
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#0099FF] rounded-xl flex items-center justify-center text-[#2D3748] font-bold text-lg shadow-lg shadow-blue-500/20">
                      {client.name.charAt(0).toUpperCase()}
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-semibold text-[#2D3748] truncate group-hover:text-emerald-400 transition-colors">
                        {client.name}
                      </h3>
                  ...
                  {/* Client Code Badge */}
                  {client.clientCode && (
                    <div className="mt-3 flex items-center justify-between bg-slate-50/50 rounded-lg px-3 py-2">
                      <span className="text-xs text-[#6B7280]">Client Code:</span>
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-md bg-slate-100/50 hover:bg-slate-200/50 text-[#6B7280] hover:text-[#2D3748] transition-colors"
                          title="Copy code"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className={`w-full mt-4 px-4 py-2.5 rounded-xl font-medium text-sm transition-all duration-200 flex items-center justify-center gap-2 ${
                      selectedClient?.id === client.id
                        ? 'bg-[#3DD6C3]/20 text-emerald-400 border border-emerald-500/30'
                        : 'bg-slate-100/50 text-[#4A5568] hover:bg-slate-200/50 hover:text-[#2D3748] border border-slate-300/50'
                    }`}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        ...
        {selectedClient && (
          <div className="mt-8 bg-white/50 backdrop-blur-xl rounded-2xl border border-slate-200/50 overflow-hidden">
            {/* Header */}
            <div className="p-6 border-b border-slate-200/50 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#3DD6C3] rounded-xl flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#2D3748]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#2D3748]">Policies for {selectedClient.name}</h3>
                  <p className="text-[#6B7280] text-sm">{policies.length} {policies.length === 1 ? 'policy' : 'policies'} total</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <button
                ...
                <button
                  ...
                  className="w-10 h-10 rounded-xl bg-slate-100/50 hover:bg-slate-200/50 flex items-center justify-center text-[#6B7280] hover:text-[#2D3748] transition-colors"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                  </svg>
            ...
            <div className="p-6">
              {policiesLoading ? (
                ...
                <div className="flex flex-col items-center text-center py-12">
                  ...
                  <h4 className="text-lg font-semibold text-[#2D3748] mb-2">No policies yet</h4>
                  <p className="text-[#6B7280] mb-4 max-w-sm">
                    Add a policy to start tracking coverage for this client.
                  </p>
                  <button
                    onClick={() => handleOpenPolicyModal()}
                    className="px-5 py-2.5 bg-[#3DD6C3] hover:bg-[#0D4D4D] text-white font-semibold rounded-xl shadow-lg shadow-[#3DD6C3]/30 hover:shadow-[#3DD6C3]/40 transition-all duration-200 flex items-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  {policies.map((policy) => (
                    <div
                      key={policy.id}
                      className="bg-slate-50/50 rounded-xl border border-slate-200/50 p-5 hover:border-slate-300/50 transition-all duration-200"
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#3DD6C3]/20 rounded-lg flex items-center justify-center text-purple-400">
                            {getPolicyTypeIcon(policy.policyType)}
                          </div>
                          <div>
                            <h4 className="font-semibold text-[#2D3748]">{policy.policyType}</h4>
                            <p className="text-[#6B7280] text-sm">#{policy.policyNumber}</p>
                          </div>
                        </div>
                      ...
                      {policy.insuranceCompany && (
                        <div className="mb-4 pb-4 border-b border-slate-200/50">
                          <p className="text-[#6B7280] text-xs uppercase tracking-wide mb-1">Insurance Company</p>
                      ...
                      {(policy.policyOwner || policy.beneficiary) && (
                        <div className="grid grid-cols-2 gap-4 mb-4 pb-4 border-b border-slate-200/50">
                          {policy.policyOwner && (
                            <div>
                              <p className="text-[#6B7280] text-xs uppercase tracking-wide mb-1">Owner</p>
                              <p className="text-[#2D3748] text-sm">{policy.policyOwner}</p>
                            </div>
                          )}
                          {policy.beneficiary && (
                            <div>
                              <p className="text-[#6B7280] text-xs uppercase tracking-wide mb-1">Beneficiary</p>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        {policy.policyType === 'Mortgage Protection' && policy.amountOfProtection && (
                          <div className="col-span-2">
                            <p className="text-[#6B7280] text-xs uppercase tracking-wide mb-1">Amount of Protection</p>
                        ...
                        {policy.policyType === 'Term Life' && policy.renewalDate && (
                          <div className="col-span-2">
                            <p className="text-[#6B7280] text-xs uppercase tracking-wide mb-1">Renewal Date</p>
                            <p className="text-[#2D3748]">{formatDate(policy.renewalDate)}</p>
                          </div>
                        )}
                        <div>
                          <p className="text-[#6B7280] text-xs uppercase tracking-wide mb-1">Death Benefit</p>
                          <p className="text-[#2D3748] font-semibold">{formatCurrency(policy.coverageAmount)}</p>
                        </div>
                        <div>
                          <p className="text-[#6B7280] text-xs uppercase tracking-wide mb-1">Premium</p>
                      ...
                      <div className="flex gap-2 mt-4 pt-4 border-t border-slate-200/50">
                        <button
                          ...
                          className="flex-1 px-3 py-2 bg-slate-100/50 hover:bg-slate-200/50 text-[#4A5568] hover:text-[#2D3748] rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative w-full max-w-md bg-white rounded-2xl border border-slate-200/50 shadow-2xl transform transition-all">
            <div className="flex items-center justify-between p-6 border-b border-slate-200/50">
              <h3 className="text-xl font-bold text-[#2D3748]">Add New Client</h3>
              <button
                onClick={handleCloseModal}
                className="w-8 h-8 rounded-lg bg-slate-100/50 hover:bg-slate-200/50 flex items-center justify-center text-[#6B7280] hover:text-[#2D3748] transition-colors"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                </svg>
            ...
            <form onSubmit={handleSubmitClient} className="p-6 space-y-5">
              ...
              <div>
                <label htmlFor="clientName" className="block text-sm font-medium text-[#4A5568] mb-2">
                  Client Name
                </label>
                <input
                  id="clientName"
                  ...
                  required
                  className="w-full px-4 py-3 bg-slate-50/50 border border-slate-300/50 rounded-xl text-[#2D3748] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all duration-200"
                  placeholder="John Doe"
                />
              </div>
              <div>
                <label htmlFor="clientEmail" className="block text-sm font-medium text-[#4A5568] mb-2">
                  Email Address
                </label>
                <input
                  id="clientEmail"
              ...
              <div>
                <label htmlFor="clientPhone" className="block text-sm font-medium text-[#4A5568] mb-2">
                  Phone Number
                </label>
                <input
                  id="clientPhone"
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={handleCloseModal}
                  className="flex-1 py-3 px-4 bg-slate-100/50 hover:bg-slate-200/50 text-[#4A5568] hover:text-[#2D3748] font-semibold rounded-xl border border-slate-300/50 transition-all duration-200"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-[#3DD6C3] hover:bg-[#0D4D4D] disabled:bg-[#3DD6C3]/50 disabled:cursor-not-allowed text-[#2D3748] font-semibold rounded-xl shadow-lg shadow-[#3DD6C3]/30 hover:shadow-[#3DD6C3]/40 transition-all duration-200 flex items-center justify-center gap-2"
                >
                  {submitting ? (
                    <>
      ...
      {isPolicyModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative w-full max-w-lg bg-white rounded-2xl border border-slate-200/50 shadow-2xl transform transition-all max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b border-slate-200/50 sticky top-0 bg-white z-10">
              <div>
                ...
                <p className="text-[#6B7280] text-sm">For {selectedClient?.name}</p>
              </div>
              <button
                onClick={handleClosePolicyModal}
                className="w-8 h-8 rounded-lg bg-slate-100/50 hover:bg-slate-200/50 flex items-center justify-center text-[#6B7280] hover:text-[#2D3748] transition-colors"
            ...
            <form onSubmit={handleSubmitPolicy} className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="policyType" className="block text-sm font-medium text-[#4A5568] mb-2">
                    Policy Type
                  </label>
                  <select
                    id="policyType"
                    ...
                    required
                    className="w-full px-4 py-3 bg-slate-50/50 border border-slate-300/50 rounded-xl text-[#2D3748] focus:outline-none focus:ring-2 focus:ring-[#3DD6C3]/50 focus:border-[#3DD6C3] transition-all duration-200"
                  >
                ...
                <div>
                  <label htmlFor="policyStatus" className="block text-sm font-medium text-[#4A5568] mb-2">
                    Status
                  </label>
                  <select
                    id="policyStatus"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="policyNumber" className="block text-sm font-medium text-[#4A5568] mb-2">
                    Policy Number
                  </label>
                  <input
                    id="policyNumber"
                    ...
                    required
                    className="w-full px-4 py-3 bg-slate-50/50 border border-slate-300/50 rounded-xl text-[#2D3748] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#3DD6C3]/50 focus:border-[#3DD6C3] transition-all duration-200"
                    placeholder="POL-2026-001234"
                  />
                </div>
                <div>
                  <label htmlFor="insuranceCompany" className="block text-sm font-medium text-[#4A5568] mb-2">
                    Insurance Company
                  </label>
                  <input
                    id="insuranceCompany"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="policyOwner" className="block text-sm font-medium text-[#4A5568] mb-2">
                    Policy Owner Name
                  </label>
                  <input
                    id="policyOwner"
                ...
                <div>
                  <label htmlFor="beneficiary" className="block text-sm font-medium text-[#4A5568] mb-2">
                    Beneficiary Name
                  </label>
                  <input
                    id="beneficiary"
              ...
              {policyFormData.policyType === 'Mortgage Protection' && (
                <div>
                  <label htmlFor="amountOfProtection" className="block text-sm font-medium text-[#4A5568] mb-2">
                  ...
                  <p className="text-[#6B7280] text-xs mt-2">Enter the protection duration (e.g., 30 Years or 360 Months)</p>
                </div>
              )}
              ...
              {policyFormData.policyType === 'Term Life' && (
                <div>
                  ...
                  <p className="text-[#6B7280] text-xs mt-2">Select the month and year of policy renewal</p>
                </div>
              )}

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="coverageAmount" className="block text-sm font-medium text-[#4A5568] mb-2">
                    Death Benefit
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-8 pr-4 py-3 bg-slate-50/50 border border-slate-300/50 rounded-xl text-[#2D3748] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#3DD6C3]/50 focus:border-[#3DD6C3] transition-all duration-200"
                      placeholder="500000"
                    />
                  </div>
                </div>
                <div>
                  <label htmlFor="premiumAmount" className="block text-sm font-medium text-[#4A5568] mb-2">
                    Monthly Premium
                  </label>
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#6B7280]">$</span>
      ...
      {deleteConfirmPolicy && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative w-full max-w-md bg-white rounded-2xl border border-slate-200/50 shadow-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#2D3748]">Delete Policy?</h3>
                <p className="text-[#6B7280] text-sm">This action cannot be undone.</p>
              </div>
            </div>
            <p className="text-[#4A5568] mb-6">
              Are you sure you want to delete the <span className="font-semibold text-[#2D3748]">{deleteConfirmPolicy.policyType}</span> policy #{deleteConfirmPolicy.policyNumber}?
            </p>
            <div className="flex gap-3">
              <button
                onClick={() => setDeleteConfirmPolicy(null)}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white rounded-2xl border border-slate-200/50 shadow-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#2D3748]">Delete Client?</h3>
                <p className="text-[#6B7280] text-sm">This action cannot be undone.</p>
              </div>
            </div>
            <p className="text-[#4A5568] mb-6">
      ...
      {isProfileModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative w-full max-w-md bg-white rounded-2xl border border-slate-200/50 shadow-2xl overflow-hidden">
            <div className="p-6 border-b border-slate-200/50">
              <h2 className="text-xl font-bold text-[#2D3748]">Edit Profile</h2>
              <p className="text-[#6B7280] text-sm mt-1">Update your profile information</p>
            </div>
              ...
              <div className="flex flex-col items-center">
                <div className="relative">
                  {agentProfile.photoBase64 ? (
                    ...
                    <div className="w-24 h-24 rounded-full bg-[#0D4D4D] flex items-center justify-center border-4 border-slate-300">
                      <span className="text-4xl font-bold text-[#2D3748]">
                        {agentProfile.name?.charAt(0).toUpperCase() || user?.email?.charAt(0).toUpperCase() || 'A'}
                      </span>
                    </div>
                  )}
                  <label className="absolute bottom-0 right-0 w-8 h-8 bg-[#3DD6C3] rounded-full flex items-center justify-center cursor-pointer hover:bg-[#0D4D4D] transition-colors shadow-lg">
                    {uploadingPhoto ? (
                ...
                <p className="text-[#6B7280] text-sm mt-3">Click camera icon to upload photo</p>
              </div>

              {/* Phone Number Field */}
              <div>
                <label htmlFor="profilePhoneNumber" className="block text-sm font-medium text-[#4A5568] mb-2">
                  Phone Number
                </label>
                <input
