...
export default function TestLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {showFoundingBanner && (
        <div className="fixed right-3 sm:right-5 top-1/3 z-[55] group">
          ...
          <Link
            ...
            className="block relative w-32 h-32 sm:w-36 sm:h-36 md:w-40 md:h-40 rounded-full bg-[#0f04dc] border-[3px] border-white/30 shadow-2xl shadow-[#0f04dc]/40 hover:scale-105 transition-all duration-300"
          >
            {/* Content */}
      ...
      {showFoundingBanner && (
        <div className="fixed top-14 sm:top-16 md:top-20 left-0 right-0 z-50 bg-[#0f04dc]">
