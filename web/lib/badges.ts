...
export interface BadgeDefinition extends Badge {
  ...
  description: string;
  /** Forward, imperative "how to earn this" line for unearned badges. */
  howToEarn: string;
  shareText: string;
...
export const BADGE_DEFINITIONS: BadgeDefinition[] = [
  // ── Founding Member (special) ────────────────────────────────
  {
    ...
    howToEarn: 'Be one of the original 50 members',
  ...
  // ── Starter tier (circle) ──────────────────────────────────
  {
    ...
    howToEarn: 'Save your first at-risk policy',
  ...
  },
  {
    ...
    howToEarn: 'Generate your first referral',
  ...
  },
  {
    ...
    howToEarn: 'Send 10 client touchpoints',
  ...
  // ── Mid tier (shield) ──────────────────────────────────────
  {
    ...
    howToEarn: 'Generate 5 referrals',
  ...
  },
  {
    ...
    howToEarn: 'Save 5 at-risk policies',
  ...
  },
  {
    ...
    howToEarn: 'Reach $1,000 in annual premium value',
  ...
  },
  {
    ...
    howToEarn: 'Recruit your first fellow agent',
  ...
  // ── Elite tier (hexagon) ───────────────────────────────────
  {
    ...
    howToEarn: 'Save 10 at-risk policies',
  ...
  },
  {
    ...
    howToEarn: 'Reach $5,000 in annual premium value',
  ...
  },
  {
    ...
    howToEarn: 'Complete 5 successful rewrites',
  ...
  },
  {
    ...
    howToEarn: 'Recruit 3 fellow agents',
  ...
  // ── Legendary tier (star) ──────────────────────────────────
  {
    ...
    howToEarn: 'Reach $10,000 in annual premium value',
  ...
  },
  {
    ...
    howToEarn: 'Recruit 5 fellow agents',
